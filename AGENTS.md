...
├── modules/
│   ├── health/
│   │   ├── AGENTS.md                ← Health module instructions — read when working on health
│   │   ├── workout/
│   │   ├── diet/
│   │   └── shared/
│   ├── budget/
...
### Reading files
- When starting a task, read only: this file + the relevant module's AGENTS.md + the specific files needed
...
See `/modules/health/AGENTS.md` for full details.
...
3. Read the relevant module's AGENTS.md
