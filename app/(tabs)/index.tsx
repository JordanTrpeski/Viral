    ...
    >
      <View style={{
        ...
        <View style={{ marginBottom: spacing.sm }}>
          <Text style={{ color: colors.text, fontSize: 22, fontWeight: '700', fontFamily: `${fonts.ui}_700Bold` }}>
            {'€'}{spent.toFixed(0)}
            <Text style={{ color: colors.textMuted, fontSize: fontSize.label, fontWeight: '400', fontFamily: `${fonts.ui}_400Regular` }}>
              {' '}/ {'€'}{income.toFixed(0)} income
            </Text>
          </Text>
        </View>
